...
void test_task6_secure_deletion()
{
    ...
    remove("delete_test.txt");
    remove("delete_test2.txt");

    /* Create test file */
    create_encrypted_file("delete_test.txt",
                          "This will be deleted",
                          FIXED_XOR_KEY);

    set_file_permission("delete_test.txt", "user1", "rwd");

    /* Test Case 1: Delete as authorized user */
    int result1 = secure_delete("delete_test.txt", "user1");
    print_test_result("Delete as owner",
                      0,
                      result1,
                      "Delete file as owner should succeed");

    /* Test Case 2: Delete non-existent file */
    int result2 = secure_delete("nonexistent.txt", "user1");
    print_test_result("Delete non-existent",
                      1,
                      result2,
                      "Delete non-existent file should return error code 1");

    /* Create another file */
    create_encrypted_file("delete_test2.txt",
                          "Another test file",
                          FIXED_XOR_KEY);

    set_file_permission("delete_test2.txt", "user1", "rwd");

    /* Test Case 3: Unauthorized delete */
    int result3 = secure_delete("delete_test2.txt",
                                "unauthorized_user");

    print_test_result("Delete unauthorized",
                      2,
                      result3,
    ...
    print_test_result("Delete NULL filename",
                      2,
                      result4,
    ...
    print_test_result("Delete NULL username",
                      2,
                      result5,
...
int main() {
    printf(BLUE "=============================================" RESET "\n");
    printf(BLUE "    FILE ENCRYPTION SYSTEM TEST CASES      " RESET "\n");
    printf(BLUE "=============================================" RESET "\n");
    printf("This test suite will evaluate all functions in the File Encryption System.\n");
    printf("Using fixed XOR key:(0x%X) for consistent results.\n",FIXED_XOR_KEY);
